...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../resource/css/student-center.css">
</head>
                    ...
                    <div class="panel-body">
                        ...
                        col-xs-9 col-sm-9 col-md-9 col-lg-9 col-xs-offset-1 col-sm-offset-1 col-md-offset-1 col-lg-offset-1">
                            ...
                            <div class="form-group">
                                <label for="school-name" class="control-label col-xs-2 col-sm-2 col-md-2 col-lg-2">你的学校：</label>
                                <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                    <input type="text" class="form-control" id="school-name" placeholder="学校全名">
                                </div>
                            </div>
                            <!--专业名称-->
                            <div class="form-group">
                                <label for="major-name" class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">你的专业：</label>
                                <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                    <input type="text" class="form-control" id="major-name" placeholder="专业全名">
                                </div>
                            </div>
                            <!--学历-->
                            <div class="form-group">
                                <label for="education" class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">你的学历：</label>
                                <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                    <select class="form-control" id="education">
                                        <option value="0">选择你的学历</option>
                            ...
                            <!--学生证-->
                            <div class="form-group">
                                <label for="card-picture" class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">你的证件：</label>
                            ...
                            <!--是否毕业-->
                            <div class="form-group">
                                <label for="is-graduate" class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">是否毕业：</label>
                                <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10" id="is-graduate">
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="graduate" value="0" checked>在校大学生
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="graduate" value="0">已毕业
                                        </label>
                                    </div>
                                </div>
                            </div>
